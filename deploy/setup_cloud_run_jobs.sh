...
# DAILY_PRECISION_HOURS_UTC=1,13 → BTC: 01:30 / 13:30, ETH: 01:40 / 13:40
...
upsert_scheduler "sched-daily-precision-btcusdt"   "daily-precision-btcusdt"   "30 1,13 * * *"
upsert_scheduler "sched-daily-precision-ethusdt"   "daily-precision-ethusdt"   "40 1,13 * * *"
